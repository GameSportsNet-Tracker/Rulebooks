...
Jeder Spieler ist dazu verpflichtet seine Steam ID (Bsp. steam\_1:2:34567) in seinen Account einzutragen. Der Spieler ist nur dann spielberechtigt, wenn die im Profil angegebene Steam ID zum Spielen verwendet wird.
...
Ein Team, das nicht länger aktiv an der Liga teilnehmen kann oder will, sollte dies via [Support-Ticket](https://liga.99damage.de/de/users/support) an die Liga-Administration kommunizieren. Es werden ausschließlich Meldungen des Team-Leaders akzeptiert.
...
Um eine Einladung in die Divisionen 2 oder 3 zu erhalten, bedarf es einer Bewerbung der Teams. Wie das Bewerbungsverfahren abläuft, kann per [Support-Ticket](https://liga.99damage.de/de/users/support) erfragt werden.
...
Ab Inkrafttreten des Roster-Locks sind keine Stand-ins von Beginn des Matches zugelassen.
...
Die Wechselslot-Regelung tritt für Saison 16 am 27.08.2020 um 18:00 Uhr (mit Ende der Anmeldephase) in Kraft.

  
  

Der Roster-Lock tritt für Saison 16 am 04.10.2020 in Kraft.
...
Es dürfen in der Saison 16 nach inkraft treten des Roster-Locks keine weiteren Spieler zum Team-Account (Saison-Lineup) hinzugefügt werden.

  
  

Die Matches deren Match-Termin nach inkraft treten des Roster-Locks liegen, als auch die anschließende Relegation, müssen mit den Spielern bestritten werden, die sich nach der Wechsel-Frist im Saison-Lineup befinden.
...
Spielerwechsel von einem Team zu einem anderen sind in der Saison 16 nach inkraft treten des Roster-Locks ausgeschlossen. Teams können dann erst wieder nach Ende der Saison wechseln.
...
Jegliche Fragen und Beschwerden zur Liga müssen per [Support-Ticket](https://liga.99damage.de/de/users/support) eingereicht werden. Die Liga-Administration ist auf anderem Wege, wie zum Beispiel Private Nachrichten, Forum oder externe Plattformen, nicht zu erreichen und wird darüber keine Fragen beantworten.
...
Die Administration duldet kein Beharren auf nur einen Tag. Zeigt ein Team keine Bereitschaft, den Spieltermin zu verschieben, ist dies der Administration spätestens 48 Stunden vor dem Standard-Termin per [Support-Ticket](https://liga.99damage.de/de/users/support) mitzuteilen.
...
Es ist immer möglich ein Match auch schon vor Beginn der Spielwoche auszuspielen soweit beide Parteien damit einverstanden sind. Der Termin muss in diesem Fall über die Kommentare unter dem Match von beiden Parteien mit Datum und Uhrzeit bestätigt werden. Sobald beide Parteien ihre Zustimmung gegeben haben, ist ein Supportticket zu eröffnen damit die Ligaadministration den Termin entsprechend einträgt.
...
Der Termin für eine Verschiebung gemäß Regel 6.2.4 muss über die Kommentare unter dem Match vereinbart und dort von beiden Parteien mit Datum und Uhrzeit bestätigt werden.
...
Das erstgenannte Team auf der Match-Seite (links) hat beim betreten des Servers die CT-Seite zu joinen und das zweitgenannte Team auf der Match-Seite (rechts) hat beim Betreten des Servers die T-Seite zu joinen.
...
Sollte ein Spectator dem Server joinen, ist das Match sofort zu pausieren und die Liga-Administration per [Support-Ticket](https://liga.99damage.de/de/users/support)  
...
Sollte die Verbindung aller Spieler zu einem Server oder dem 99Bot abbrechen und das erneute Beitreten auf einen Server nicht möglich sein, ist die Liga-Administration via [Support-Ticket](https://liga.99damage.de/de/users/support) unverzüglich zu informieren. Das Match ist dann bis auf weiteres verschoben.  
